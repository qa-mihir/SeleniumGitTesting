...
public class TestConfig{
	...
	public static String from = "mihir.nit@gmail.com";
	public static String password = "Devilhunter69";
	public static String[] to ={"mihirtailor1994@gmail.com"};
	public static String subject = "Test Mail";
	
	public static String messageBody ="I am testing mail";
